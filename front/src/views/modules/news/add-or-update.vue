        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.newsVideo" label="新闻视频" prop="newsVideo">
                        <file-upload
                            tip="点击上传新闻视频"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.newsVideo" label="新闻视频" prop="newsVideo">
